...
export default function DSGVO(){
  ...
  const router = useRouter()
    ...
    return(
        <>
      <Header title={"MSVS - DSGVO"} content={"MSVS - Datenschutzerklärung"} url={headUrl} />
        <main>
        <section className={s.section}>
          <h2>Datenschutzerklärung</h2> 

	<p>Matchschützenvereinigung Schaffhausen
		{"\n"}
	Schaffhausen 8200
	{"\n"}
	Schweiz
	...
	<h3>Datenschutzbeauftragte Person:</h3>
	<p>Marcel Weber {"\n"} mrweber@gmx.ch</p>
 ...
 {"\n"} 
	...
	<p>Der Provider dieser Website erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:
	<ul>
	...
	<p>Diese Website kann Google Maps zur Einbettung von Karten, Google Invisible reCAPTCHA zum Schutz vor Bots und Spam und YouTube zur Einbettung von Videos nutzen.
	 {"\n"} 
	  {"\n"} 
...
{"\n"} 
	...
	</li><li>Die betroffene Person widerruft die Einwilligung, auf der die Verarbeitung beruhte, und es gibt keine andere Rechtsgrundlage für die Verarbeitung
	</li><li>Die betroffene Person legt aus Gründen, die sich aus ihrer besonderen Situation ergeben, Widerspruch gegen die Verarbeitung ein, und es liegen keine vorrangigen berechtigten Gründe für die Verarbeitung vor, oder die betroffene Person legt im Falle von Direktwerbung und damit verbundenem Profiling Widerspruch gegen die Verarbeitung ein
	</li><li>Die personenbezogenen Daten wurden unrechtmäßig verarbeitet
	</li><li>Die Löschung der personenbezogenen Daten ist zur Erfüllung einer rechtlichen Verpflichtung nach dem Unionsrecht oder dem Recht der Mitgliedstaaten erforderlich, dem der für die Verarbeitung Verantwortliche unterliegt
	</li><li>Die personenbezogenen Daten wurden in Bezug auf angebotene Dienste der Informationsgesellschaft erhoben, die direkt an ein Kind gerichtet sind
	</li>
	</ul>Wenn einer der oben genannten Gründe zutrifft und Sie die Löschung von personenbezogenen Daten, die beim Betreiber dieser Website gespeichert sind, veranlassen möchten, können Sie sich jederzeit an unseren Datenschutzbeauftragten wenden. Der Datenschutzbeauftragte dieser Website wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird. 
	...
	<ul>
		<li>Die Richtigkeit der personenbezogenen Daten wird von der betroffenen Person bestritten, und zwar für einen Zeitraum, der es dem für die Verarbeitung Verantwortlichen ermöglicht, die Richtigkeit der personenbezogenen Daten zu überprüfen
	</li><li>Die Verarbeitung ist unrechtmäßig, die betroffene Person legt Widerspruch gegen die Löschung der personenbezogenen Daten ein und verlangt stattdessen die Einschränkung der Nutzung der personenbezogenen Daten
	</li><li>Der für die Verarbeitung Verantwortliche benötigt die personenbezogenen Daten nicht mehr für die Zwecke der Verarbeitung, die betroffene Person benötigt sie jedoch für die Geltendmachung, Die betroffene Person hat aus Gründen, die sich aus ihrer besonderen Situation ergeben, Widerspruch gegen die Verarbeitung eingelegt, und es steht noch nicht fest, ob die berechtigten Interessen des Verantwortlichen gegenüber denen der betroffenen Person überwiegen
	</li>
	</ul>Wenn eine der vorgenannten Voraussetzungen gegeben ist, können Sie sich jederzeit an unseren Datenschutzbeauftragten wenden, um die Einschränkung der Verarbeitung personenbezogener Daten beim Betreiber dieser Website zu verlangen.  Der Datenschutzbeauftragte dieser Website wird die Einschränkung der Verarbeitung veranlassen.
{"\n"} 
{"\n"} 
	...
	<h3>Urheberrechte</h3>
	<p>Das Urheberrecht und alle anderen Rechte an den Inhalten, Bildern, Fotos oder sonstigen Dateien auf der Website gehören ausschließlich dem Betreiber dieser Website oder den namentlich genannten Rechteinhabern. Für die Vervielfältigung sämtlicher Dateien muss vorab die schriftliche Zustimmung der Urheberrechtsinhaber eingeholt werden.
	{"\n"} 
	...
	<p>Alle Angaben auf unserer Website wurden sorgfältig geprüft. Wir sind bemüht, dafür Sorge zu tragen, dass die von uns bereitgestellten Informationen aktuell, richtig und vollständig sind. Dennoch ist das Auftreten von Fehlern nicht völlig auszuschließen, so dass wir für die Vollständigkeit, Richtigkeit und Aktualität der Informationen, auch journalistisch-redaktioneller Art, keine Gewähr übernehmen können. Haftungsansprüche, die sich auf Schäden materieller oder ideeller Art beziehen, welche durch die Nutzung oder Nichtnutzung der dargebotenen Informationen bzw. durch die Nutzung fehlerhafter und unvollständiger Informationen verursacht wurden, sind grundsätzlich ausgeschlossen.
	{"\n"} 
	...
	<p>Diese Website verwendet den reCAPTCHA-Dienst von Google Ireland Limited (Gordon House, Barrow Street Dublin 4, Irland &quo;Google&quo;). Die Abfrage dient dazu, zu unterscheiden, ob die Eingabe durch einen Menschen oder durch eine automatisierte, maschinelle Verarbeitung erfolgt. Die Abfrage beinhaltet die Übermittlung der IP-Adresse und ggf. weiterer von Google für den reCAPTCHA-Dienst benötigter Daten an Google. Zu diesem Zweck wird Ihre Eingabe an Google übermittelt und dort weiterverwendet. Ihre IP-Adresse wird von Google jedoch innerhalb von Mitgliedstaaten der Europäischen Union oder in anderen Vertragsstaaten des Abkommens über den Europäischen Wirtschaftsraum zuvor gekürzt. Nur in Ausnahmefällen wird die volle IP-Adresse an einen Server von Google in den USA übertragen und dort gekürzt. Im Auftrag des Betreibers dieser Website wird Google diese Informationen benutzen, um Ihre Nutzung dieses Dienstes auszuwerten. Die im Rahmen von reCaptcha von Ihrem Browser übermittelte IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt. Ihre Daten können dabei auch in die USA übertragen werden. Für Datenübermittlungen in die USA gibt es einen Angemessenheitsbeschluss der Europäischen Kommission, das &quo;Privacy Shield&quo;. Google nimmt an dem &quo;Privacy Shield&quo; teil und hat sich den Anforderungen unterworfen. Durch Betätigen der Abfrage stimmen Sie der Verarbeitung Ihrer Daten zu. Die Verarbeitung erfolgt auf Grundlage von Art. 6 (1) lit. a DSGVO mit Ihrer Einwilligung. Sie können Ihre Einwilligung jederzeit widerrufen, ohne dass die Rechtmäßigkeit der aufgrund der Einwilligung bis zum Widerruf erfolgten Verarbeitung berührt wird.
	{"\n"} 
	...
	<p>Der Google Tag Manager ist eine Lösung, mit der wir über eine Schnittstelle sogenannte Website-Tags verwalten und so z.B. Google Analytics und andere Google-Marketingdienste in unser Online-Angebot integrieren können. Der Tag Manager selbst, der die Tags implementiert, verarbeitet keine personenbezogenen Daten der Nutzer. Hinsichtlich der Verarbeitung personenbezogener Daten der Nutzer verweisen wir auf die folgenden Informationen zu den Google-Diensten. Verwendungsrichtlinien: https://www.google.com/intl/<wbr/>de/tagmanager/use-policy.html.
</p>
	<h3>Facebook</h3>
	<p>Diese Website nutzt Funktionen der Facebook Inc, 1601 S. California Ave, Palo Alto, CA 94304, USA . Wenn Sie unsere Seiten mit Facebook-Plugins aufrufen, wird eine Verbindung zwischen Ihrem Browser und den Facebook-Servern hergestellt. Dabei werden bereits Daten an Facebook übermittelt. Wenn Sie ein Facebook-Konto besitzen, können diese Daten mit diesem verknüpft werden. Wenn Sie nicht möchten, dass diese Daten mit Ihrem Facebook-Konto verknüpft werden, loggen Sie sich bitte vor dem Besuch unserer Seite bei Facebook aus. Interaktionen, insbesondere die Nutzung einer Kommentarfunktion oder das Anklicken eines &quo;Gefällt mir&quo;- oder &quo;Teilen&quo;-Buttons, werden ebenfalls an Facebook weitergeleitet. Mehr dazu erfahren Sie unter https://de-de.facebook.com/about/privacy.
</p>
	<h3>Twitter</h3>
	<p>Diese Website nutzt Funktionen der Twitter, Inc. 1355 Market St, Suite 900, San Francisco, CA 94103, USA. Wenn Sie unsere Seiten mit Twitter-Plug-Ins aufrufen, wird eine Verbindung zwischen Ihrem Browser und den Servern von Twitter hergestellt. Dabei werden bereits Daten an Twitter übertragen. Wenn Sie ein Twitter-Konto besitzen, können diese Daten mit diesem verknüpft werden. Wenn Sie nicht möchten, dass diese Daten mit Ihrem Twitter-Account verknüpft werden, loggen Sie sich bitte vor dem Besuch unserer Seite bei Twitter aus. Interaktionen, insbesondere das Anklicken einer &quo;Re-Tweet&quo;-Schaltfläche, werden ebenfalls an Twitter weitergeleitet. Mehr dazu erfahren Sie unter https://twitter.com/privacy.
</p>
	<h3>Instagram</h3>
	...
	<h3>YouTube</h3>
	<p>Auf dieser Website sind Funktionen des Dienstes &quo;YouTube&quo; integriert. &quo;YouTube&quo; ist Eigentum von Google Ireland Limited, einem nach irischem Recht gegründeten und betriebenen Unternehmen mit Sitz in Gordon House, Barrow Street, Dublin 4, Irland, das die Dienste im Europäischen Wirtschaftsraum und in der Schweiz betreibt. 
	{"\n"}Ihre rechtliche Vereinbarung mit &quo;YouTube&quo; besteht aus den Bedingungen, die Sie unter dem folgenden Link finden: https://www.youtube.com/static?gl=de&template=terms&hl=de. Diese Bedingungen stellen eine rechtsverbindliche Vereinbarung zwischen Ihnen und &quo;YouTube&quo; bezüglich Ihrer Nutzung der Dienste dar. In den Datenschutzbestimmungen von Google wird erläutert, wie &quo;YouTube&quo; Ihre persönlichen Daten behandelt und schützt, wenn Sie den Dienst nutzen.
</p>
	...
	<h3>Haftungsausschluss</h3>
	<p>Der Autor übernimmt keine Gewähr für die Richtigkeit, Genauigkeit, Aktualität, Zuverlässigkeit und Vollständigkeit der Informationen.
	...
	<p>Alle Angebote sind freibleibend. Der Autor behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.
</p>
	<h3>Quelle</h3>: 
	<p><u><em><Link href='https://brainbox.swiss/'> BrainBox Solutions</Link></em></u>
</p>
        </section>
        </main>
